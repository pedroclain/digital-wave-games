...
export class AuthService {
  ...
  constructor(private http: HttpClient, private cookieService: CookieService, private jwtService: JwtService) { }
  ...
  getPayload() {
    if (!this.payload) this.payload = this.jwtService.decode(this.getAccessToken());
